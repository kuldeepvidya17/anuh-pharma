                    ...
                    <div id="CCForm1" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><input disabled type="text"
                                                                name="product_details[0][serial]" value="1"></td>
                                                        <td><input type="text" name="product_details[0][product_name]">
                                                        </td>
                                                        <td><input type="text" name="product_details[0][batch_no]">
                                                        </td>
                                                        <td><input type="date" name="product_details[0][mfg_date]">
                                                        </td>
                                                        <td><input type="date" name="product_details[0][exp_date]">
                                                        </td>
                                                        <td><input type="text" name="product_details[0][batch_size]">
                                                        </td>
                                                        <td><input type="date"
                                                                name="product_details[0][dispatch_date]"></td>
                                                        <td><input type="text" name="product_details[0][dispatch_qty]">
                                                        </td>
                                                        <td><input type="date"
                                                                name="product_details[0][completion_date]"></td>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="repeat">Acknowledgment Sent to Customer Through Marketing Department
                                            by Head QA </label>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="history_details"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><input disabled type="text"
                                                                name="history_details[0][serial]" value="1"></td>
                                                        <td><input type="text" name="history_details[0][receipt_date]">
                                                        </td>
                                                        <td><input type="text"
                                                                name="history_details[0][received_from]"></td>
                                                        <td><input type="text"
                                                                name="history_details[0][nature_of_complaint]"></td>
                                                        <td><input type="text" name="history_details[0][capa_taken]">
                                                        </td>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="repeat">Analysis / Physical examination of control sample to be
                                            done</label>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="material_details"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><input disabled type="text"
                                                                name="material_details[0][serial]" value="1"></td>
                                                        <td><input type="text" name="material_details[0][batch_no]">
                                                        </td>
                                                        <td><input type="text"
                                                                name="material_details[0][physical_test]"></td>
                                                        <td><input type="text" name="material_details[0][observation]">
                                                        </td>
                                                        <td><input type="text"
                                                                name="material_details[0][specification]"></td>
                                                        <td><input type="text"
                                                                name="material_details[0][batch_disposition_decision]">
                                                        </td>
                                                        <td><input type="text" name="material_details[0][remark]"></td>
                                                        <td><input type="text"
                                                                name="material_details[0][batch_status]"></td>
                                                        <td><button type="button" class="removeRowBtn">Remove</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                        ...
                        <div class="inner-block-content">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="Quality Control">
                                            Quality Control 2
                                            <button type="button" name="add_quality_control_2"
                                                id="quality_add_2">+</button>
                                        </label>
                                        <table class="table table-bordered" id="quality_details_2">
                                            ...
                                            <tbody>
                                                <!-- Default first row -->
                                                <tr>
                                                    <td><input disabled type="text" name="qualitycontrol_2[0][serial]"
                                                            value="1"></td>
                                                    <td><input type="text" name="qualitycontrol_2[0][test]"></td>
                                                    <td><input type="text" name="qualitycontrol_2[0][control_sample]">
                                                    </td>
                                                    <td><input type="text"
                                                            name="qualitycontrol_2[0][complaint_sample]"></td>
                                                    <td><input type="text" name="qualitycontrol_2[0][final_result]">
                                                    </td>
                                                    <td><input type="text" name="qualitycontrol_2[0][standards]"></td>
                                                    <td><input type="text" name="qualitycontrol_2[0][observation]">
                                                    </td>
                                                    <td><input type="text"
                                                            name="qualitycontrol_2[0][batch_verification]"></td>
                                                    <td><button type="button" class="removeRowBtn">Remove</button></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        $('#quality_add_2').click(function(e) {
                                            ...
                                            function generateQualityTableRow(serialNumber) {
                                                var html =
                                                    ...
                                                    '][serial]" value="' + (serialNumber + 1) + '"></td>' +
                                                    '<td><input type="text" name="qualitycontrol_2[' + serialNumber + '][test]"></td>' +
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="complaint_details"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><input disabled type="text"
                                                                name="complaint_details[0][row]" value="1"></td>
                                                        <td><input type="text"
                                                                name="complaint_details[0][customer_name]"></td>
                                                        <td><input type="text"
                                                                name="complaint_details[0][dispatched_qty]"></td>
                                                        <td><button type="button" class="removeRowBtn">Remove</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                            ...
                            <div class="col-12 sub-head">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="changecontrol_details"
                                                style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><input disabled type="text"
                                                                name="changecontrol_capa_details[0][row]" value="1"></td>
                                                        <td><input type="text"
                                                                name="changecontrol_capa_details[0][Details_of_Change_Control]"></td>
                                                        <td><input type="date"
                                                                name="changecontrol_capa_details[0][date_of_initiation]"></td>
                                                        <td><button type="button" class="removeRowBtn">Remove</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                    ...
                                    $(document).ready(function() {
                                        ...
                                        $('#changecontrol_add').click(function(e) {
                                            ...
                                            function generateComplaintTableRow(serialNumber) {
                                                var html =
                                                    '<tr>' +
                                                    '<td><input disabled type="text" name="changecontrol_capa_details[' + serialNumber +
                                                    '][row]" value="' + (serialNumber + 1) + '"></td>' +
                                                    '<td><input type="text" name="changecontrol_capa_details[' + serialNumber +
                                                    '][Details_of_Change_Control]"></td>' +
                                                    '<td><input type="date" name="changecontrol_capa_details[' + serialNumber +
                                                    '][date_of_initiation]"></td>' +
                                                    '<td><button type="button" class="removeRowBtn">Remove</button></td>' +
                                                    '</tr>';
                                                return html;
                                            }

                                            var tableBody = $('#changecontrol_capa_details tbody');
                                            var rowCount = tableBody.children('tr').length;
                                            var newRow = generateComplaintTableRow(rowCount);
                                            tableBody.append(newRow);
                                        });
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea name="head_qulitiy_comment"></textarea>
                                </div>
                            </div>
