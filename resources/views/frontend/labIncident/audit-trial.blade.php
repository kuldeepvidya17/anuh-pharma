    ...
    <header>
       ...
       <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="buttons-new">
                ...
                <button class="button_theme1" ><a class="text-white" href="{{ url('rcms/LabIncidentShow/' . $document->id)  }}"> Back
                </a>
                </button>
       ...
       <div class="modal fade" id="auditReviewer">
        ...
        <div class="heading">
            ...
            <div style="margin-bottom: 5px;  font-weight: bold;"> Originator :{{ Helpers::getInitiatorName($document->initiator_id) ? Helpers::getInitiatorName($document->initiator_id) : '' }}</div>
            <div style="margin-bottom: 5px; font-weight: bold;">Short Description : {{$document->short_desc}}</div>
