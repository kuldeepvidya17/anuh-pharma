    ...
    <div class="main-head">Record Workflow </div>
        <div class="d-flex" style="gap:20px;">
            ...
            @endphp
             ...
             <button class="button_theme1"> <a class="text-white" href="{{ route('audit_trial', $data->id) }}"> Audit Trail </a> </button>
...
<div class="modal fade" id="signature-modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="sendstage" action="{{ route('send_stage', $data->id) }}" method="POST">
            @csrf
            <!-- Modal body -->
...
<div class="modal fade" id="request-more-info-modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('requestmoreinfo_back_stage', $data->id) }}" method="POST">
            @csrf
            <!-- Modal body -->
            <div class="modal-body">
...
<div class="modal fade" id="signature-modal-AssignableCause">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="assignable" action="{{ route('assignable_send_stage', $data->id) }}" method="POST">
            @csrf
            <!-- Modal body -->
            <div class="modal-body">
...
<div class="modal fade" id="cancel-modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="cancelstage" action="{{ route('cancel_stage', $data->id) }}" method="POST">
                @csrf
                <!-- Modal body -->
                <div class="modal-body">
                    <div class="mb-3 text-justify">
...
<div class="modal fade" id="Done-modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="Donestage" action="{{ route('Done_stage', $data->id) }}" method="POST">
                @csrf
                <!-- Modal body -->
                <div class="modal-body">
                    <div class="mb-3 text-justify">
...
<div class="modal fade" id="Done-modal1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="Donestage1" action="{{ route('Done_One_stage', $data->id) }}" method="POST">
                @csrf
                <!-- Modal body -->
                <div class="modal-body">
                    <div class="mb-3 text-justify">
...
<div class="modal fade" id="Done-modal2">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="Donestage2" action="{{ route('Done_Two_stage', $data->id) }}" method="POST">
                @csrf
                <!-- Modal body -->
                <div class="modal-body">
                    <div class="mb-3 text-justify">
...
<div class="modal fade" id="child-modal-rootcause-analysis">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('child', $data->id) }}" method="POST">
                @csrf
                <!-- Modal body -->
                <div class="modal-body">
                    <div class="group-input">
