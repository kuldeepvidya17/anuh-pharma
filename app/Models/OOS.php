...
class OOS extends Model
{
    ...
    protected $fillable = [
          ...
          'investigator',
          'Discussion_points',
          'Remark_qc_investigator',
          'preliminary_investigation_response',
          'simple_analyzed',
          'corrective_action',
          'preventive_action1A',
          'outcome_phase_i_investigation',
          'evaluation_by_head_quality',
          'hypothesis_analysis',
          'results_hypothesis',
          'evaluation_of_hypothesis_comments',
          'hypothesis_root_cause',
          'impact_assessment_risk',
          'preventive_action_phase1b',
          'outcome_phase_ib_investigation2',
          'hypothesis_analysis_phase2',
          'results_hypothesis_phase2',
          'hypothesis_root_cause_phase2',
          'evaluation_of_hypothesis_comments_phase2',
          'impact_assessment_risk_phase2',
          'preventive_action_phase2',
          'evaluation_by_head_quality_disignee_phase2',
          'evaluation_by_head_quality_phase3',
          'outcome_phase_ii_investigation2',
          'phase_ii_investigation',
          'phase_iii_evaluation',
          'brief_summary_root_cause',
          'brief_summary_taken_planned',
          'comment_of_head_qualiry',
          'recommendation_for_batch',
          'phaseiii_results',
          'phaseiii_limit',
          'conclusion',
          ...
          'impact_assessment_on_batches',
          'conclusion_by_qc_head',
          'phase_iii_corrective',
          'phase_iii_preventive',
          'phase_iii_investigation',
          'justification_delay_no',
          'justification_closure_date',
          'justification_extended_date',
          'justification_text',
          'repeat_nature_gi',
          'nature_of_change_gi',
    ...
    protected $casts = [
      ...
      'outcome_phase_ib_investigation2' => 'array',
