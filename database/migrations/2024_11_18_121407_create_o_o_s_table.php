...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('o_o_s', function (Blueprint $table) {
            ...
            $table->longtext('simple_analyzed')->nullable();
            $table->longtext('investigator')->nullable();
            $table->longtext('corrective_action')->nullable();
            $table->longtext('preventive_action1A')->nullable();
            $table->longtext('outcome_phase_i_investigation')->nullable();
            $table->longtext('evaluation_by_head_quality')->nullable();
            $table->longtext('hypothesis_analysis')->nullable();
            $table->longtext('results_hypothesis')->nullable();
            $table->longtext('evaluation_of_hypothesis_comments')->nullable();
            $table->longtext('hypothesis_root_cause')->nullable();
            $table->longtext('impact_assessment_risk')->nullable();
            $table->longtext('preventive_action_phase1b')->nullable();
            $table->longtext('outcome_phase_ib_investigation2')->nullable();
            $table->longtext('results_hypothesis_phase2')->nullable();
            $table->longtext('evaluation_of_hypothesis_comments_phase2')->nullable();
            $table->longtext('hypothesis_root_cause_phase2')->nullable();
            $table->longtext('hypothesis_analysis_phase2')->nullable();
            $table->longtext('impact_assessment_risk_phase2')->nullable();
            $table->longtext('preventive_action_phase2')->nullable();
            $table->longtext('evaluation_by_head_quality_disignee_phase2')->nullable();
            $table->longtext('outcome_phase_ii_investigation2')->nullable();
            $table->longtext('phase_ii_investigation')->nullable();
            $table->longtext('brief_summary_root_cause')->nullable();
            $table->longtext('brief_summary_taken_planned')->nullable();
            $table->longtext('comment_of_head_qualiry')->nullable();
            $table->longtext('recommendation_for_batch')->nullable();
            $table->longtext('phaseiii_results')->nullable();
            $table->longtext('phaseiii_limit')->nullable();
            $table->longtext('conclusion')->nullable();
            $table->longtext('reason_justification')->nullable();
            $table->longtext('material_results')->nullable();
            $table->longtext('material_conclusion')->nullable();
            $table->longtext('evaluation_by_quality_designee')->nullable();
            $table->longtext('phase_iii_investigator')->nullable();
            $table->longtext('average_all_six_result')->nullable();
            $table->longtext('phase_iii_investigator_result1')->nullable();
            $table->longtext('conclusion_by_qc_head')->nullable();
            $table->longtext('impact_assessment_on_batches')->nullable();
            $table->longtext('justification_delay_no')->nullable();
            $table->longtext('justification_closure_date')->nullable();
            $table->longtext('justification_extended_date')->nullable();
            $table->longtext('justification_text')->nullable();
            $table->longtext('phase_iii_corrective')->nullable();
            $table->longtext('phase_iii_preventive')->nullable();
            $table->longtext('phase_iii_evaluation')->nullable();
            $table->longtext('phase_iii_investigation')->nullable();
            $table->longtext('description_summary')->nullable();
            $table->longtext('evaluation_by_head_quality_phase3')->nullable();
